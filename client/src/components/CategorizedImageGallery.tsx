...
export default function CategorizedImageGallery({ images, title }: CategorizedImageGalleryProps) {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredImages.map((image, index) => (
            ...
            >
              ...
              {/* Category Badge */}
              <div className="absolute top-3 right-3 bg-blue-700 text-white px-3 py-1 rounded-full text-xs font-semibold">
                {image.category}
              </div>
            </div>
          ))}
